...
public class repComplaintListController {
    @FXML
    private Button dBtn;
    ...
    private void openDashboard(ActionEvent event) throws IOException {
        URL url = new File("src/main/java/com/southstar/apappfe/fxml/resources/com/southstar/apappfe/rep/repDashboard.fxml").toURI().toURL();
